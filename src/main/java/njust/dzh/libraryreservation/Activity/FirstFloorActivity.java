...
public class
FirstFloorActivity extends AppCompatActivity {
            ...
            public void onClick(View view) {
                AlertDialog alertDialog = new AlertDialog.Builder(view.getContext())
                        ...
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                if (seatDao.getSeats(account) != null) {
                                    Toast.makeText(FirstFloorActivity.this, "预订失败，您有预定的座位未退订", Toast.LENGTH_SHORT).show();
                                } else {
                                    seatDao.addFirstSeats(seat);
                                    Toast.makeText(FirstFloorActivity.this, "预订成功！", Toast.LENGTH_SHORT).show();
                                }
                                seatDao.close();
                            }
                        })
                        .setNegativeButton("取消", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                Toast.makeText(FirstFloorActivity.this, "预订已取消", Toast.LENGTH_SHORT).show();
                            }
                        })
                        .show();
            }
    ...
    private void initSeats() {
        ...
        seatDao.open();
        seatList = seatDao.getFirstSeats();
        seatDao.close();
        // 获取所有单选按钮实例
        ...
        RadioButton seat23 = findViewById(R.id.seat23);
        ...
        RadioButton seat73 = findViewById(R.id.seat73);
        ...
        RadioButton []radioArray = new RadioButton[] {seat11, seat12, seat13, seat21, seat22, seat23,
        seat31, seat32, seat33, seat41, seat42, seat51, seat52, seat61, seat62, seat63, seat71, seat72,
        seat73, seat81, seat82, seat83};
